...
if __name__ == '__main__':
    ...
    p = hb.ProjectFlow(r'../../projects/gtap_invest_pnas')
    ...
    p.run_type = 'just_figs' # Can choose from 'allocation_run, 'complete_run', 'extract_calibration_from_project', 'calculate_carbon'
...
#     p = hb.ProjectFlow(r'../../projects/gtap_invest_pnas')
#     p.base_data_dir = os.path.join('C:\\', 'Files', 'Research', 'base_data')
...
#     p.gtap_scenario_coarse_state_paths['rcp45_ssp2'][2030]['PESGC'] = hb.luh_scenario_states_paths['rcp45_ssp2']
#     p.gtap_scenario_coarse_state_paths['rcp45_ssp2'][2050]['PESGC'] = hb.luh_scenario_states_paths['rcp45_ssp2']
...
#     ## URIS STYLE GTAP RELEASE
#     # This is a zipfile I received from URIS that has all the packaged GTAP files ready to run. Extract these to a project dir.
#     p.gtap_aez_invest_release_string = 'PNAS-Apr22'
#     # p.gtap_aez_invest_release_string = '04_20_2021_GTAP_AEZ_INVEST'
#     p.gtap_aez_invest_zipfile_path = os.path.join(p.model_base_data_dir, 'gtap_aez_invest_releases', p.gtap_aez_invest_release_string + '.zip')
#     p.gtap_aez_invest_proc_zipfile_path = os.path.join(p.model_base_data_dir, 'gtap_aez_invest_releases', '00_InVEST_proc.zip')
#     p.gtap_aez_invest_code_dir = os.path.join(p.script_dir, 'gtap_aez', p.gtap_aez_invest_release_string)
...
#     p.gtap_pretrained_coefficients_path_dict['rcp45_ssp2'][2030]['BAU_rigid'] = os.path.join(hb.SEALS_BASE_DATA_DIR, 'input', 'gtap_trained_coefficients_combined_with_constraints.xlsx')
#     p.gtap_pretrained_coefficients_path_dict['rcp45_ssp2'][2050]['BAU_rigid'] = os.path.join(hb.SEALS_BASE_DATA_DIR, 'input', 'gtap_trained_coefficients_combined_with_constraints.xlsx')
...
#     p.coarse_ha_per_cell_path = hb.pyramid_ha_per_cell[p.coarse_arcseconds]
...
#     # SEALS tasks
#     p.scenarios_task = p.add_iterator(seals_main.scenarios, run_in_parallel=False,                                          run=0, skip_if_dir_exists=0)  # CAREFUL Make these all change together.
...
#     p.stitched_lulcs_task = p.add_task(seals_main.stitched_lulcs,                                                           run=0, skip_if_dir_exists=0)
#     p.map_esa_simplified_back_to_esa_task = p.add_task(seals_main.map_esa_simplified_back_to_esa,                           run=0, skip_if_dir_exists=0)
